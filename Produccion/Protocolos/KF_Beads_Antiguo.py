...
# #####################################################
metadata = {
    'protocolName': 'KingFisher Beads Antiguo',
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # Tubes
    # -----------------------------------------------------
    protK_tube = Tube(name = 'Generic 2mL safelock snapcap Tubes',
                actual_volume = 1900,
                max_volume = 2000,
	...
	def step2():
        ...
        list_dest = list(divide_destinations(dest_rack.wells(),8))
    ...
    # -----------------------------------------------------
    STEPS = {
        1:{'Execute': True,  'Function': step1, 'Description': 'Transfer Beads'}
    }
