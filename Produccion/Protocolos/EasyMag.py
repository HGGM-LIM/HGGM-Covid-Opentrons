...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # Labware
    # -----------------------------------------------------
    buffer_rack = robot.load_labware('opentrons_6_tuberack_falcon_50ml_conical', '5',
    ...
    # Tubes
    # -----------------------------------------------------
    easyMag_tube1 = Tube(name = 'Falcon 50mL Conical Centrifuge Tubes',
                actual_volume = 40000,
                max_volume = 50000,
    ...
    easyMag_tube2 = Tube(name = 'Falcon 50mL Conical Centrifuge Tubes',
                actual_volume = 40000,
                max_volume = 50000,
                diameter = 27.81, # avl1.diameter
                base_type = 2,
    ...
    easyMag_tube3 = Tube(name = 'Falcon 50mL Conical Centrifuge Tubes',
                actual_volume = 40000,
                max_volume = 50000,
                diameter = 27.81, # avl1.diameter
                base_type = 2,
    ...
    easyMag_tube4 = Tube(name = 'Falcon 50mL Conical Centrifuge Tubes',
                actual_volume = 40000,
                max_volume = 50000,
                diameter = 27.81, # avl1.diameter
                base_type = 2,
    ...
    def step1():
        ...
        for rack in dest_racks1:
            distribute_custom(pip = p1000,
                         reagent = easyMag_reagent,
                         tube_type = easyMag_tube1,
                         volume = 800,
                         src = kpcr,
                         dest = rack.wells(),
                         disp_height = 20,
        ...
        p1000.aspirate(volume=5, location=kpcr.top())       
    ...
    def step2():
        ...
        # transfer buffer to tubes
        for rack in dest_racks2:
            distribute_custom(pip = p1000,
                         reagent = easyMag_reagent,
                         tube_type = easyMag_tube2,
                         volume = 800,
                         src = kpcr,
                         dest = rack.wells(),
                         disp_height = 20,
    ...
    def step3():
        ...
        # transfer buffer to tubes
        for rack in dest_racks3:
            distribute_custom(pip = p1000,
                         reagent = easyMag_reagent,
                         tube_type = easyMag_tube3,
                         volume = 800,
                         src = kpcr,
                         dest = rack.wells(),
                         disp_height = 20,
    ...
    def step4():
        ...
        # transfer buffer to tubes
        for rack in dest_racks4:
            distribute_custom(pip = p1000,
                         reagent = easyMag_reagent,
                         tube_type = easyMag_tube4,
                         volume = 800,
                         src = kpcr,
                         dest = rack.wells(),
                         disp_height = 20,
    ...
    # -----------------------------------------------------
    STEPS = {
        1:{'Execute': True,  'Function': step1, 'Description': 'Transfer buffer'},
        2:{'Execute': True,  'Function': step2, 'Description': 'Transfer buffer'},
        3:{'Execute': True,  'Function': step3, 'Description': 'Transfer buffer'},
        4:{'Execute': True,  'Function': step4, 'Description': 'Transfer buffer'}
    }
