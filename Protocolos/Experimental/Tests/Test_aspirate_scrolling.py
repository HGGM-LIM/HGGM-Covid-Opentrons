...
def remove_supernatant(pip, reagent, tube_type, volume, src, 
    ...
    for vol in list_vol_per_round:
        ...
        aspirate_wit_scrolling(pip = pip,
                            volume=vol, 
                            src=src,
                            x_offset_src=x_offset_src)
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # -----------------------------------------------------
    STEPS = {
        1:{'Execute': False, 'Function': magnet_on,  'Description': 'Activar el módulo magnético', 'wait_time': 180},
        2:{'Execute': True, 'Function': tagp_midi,  'Description': 'Transferir 45 µL de sobrenadante de TAGP a MIDI'},
        3:{'Execute': False, 'Function': magnet_off, 'Description': 'Desactivar el módulo magnético'},
    }
