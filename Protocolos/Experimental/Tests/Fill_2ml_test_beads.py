...
def run(ctx: protocol_api.ProtocolContext):
    ...
    protK_tube = Tube(name = 'Generic 2mL Tubes',
                actual_volume = 1900,
                max_volume = 2000,
    ...
    def step2():
        ...
        lisis = buffer_rack['A1']
        
        protK = protK_rack['A1']
                        
        for _ in range(1):
            p1000.aspirate(volume=1000, location=lisis.bottom(80))
            p1000.dispense(volume=1000, location=protK.top())
    ...
    # -----------------------------------------------------
    STEPS = {
        1:{'Execute': True,  'Function': step2, 'Description': 'Transfer Color to source'}
    }
