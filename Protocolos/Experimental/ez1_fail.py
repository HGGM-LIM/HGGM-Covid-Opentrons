...
def run(ctx: protocol_api.ProtocolContext):
    ...
    dest_rack_1 = ctx.load_labware('opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap', '4',
        '24_tuberack_starsted source rack')

    dest_rack_2 = ctx.load_labware('opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap', '5',
        '24_tuberack_starsted source rack')

    dest_rack_3 = ctx.load_labware('opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap', '8',
        '24_tuberack_starsted source rack')
    ...
    # Reagens
    # -----------------------------------------------------
    carrier_ez1_reagent = Reagent(name = 'Positive control Master Mix',
    ...
    # Tubes
    # -----------------------------------------------------
    redcap_tube = Tube(name = 'Red Cap Tube',
                actual_volume = 3170,
                max_volume = 10000,
                diameter = 13.08, # avl1.diameter
                base_type = 1,
                height_base = 106.53)
    ...
    def step1():
        ...
        dest = dest_rack_1.wells()[:24]

        # transfer buffer to tubes
        for rack in dest_rack_1:
    ...
    def step2():
        ...
        dest = dest_rack_2.wells()[:24]

        # transfer buffer to tubes
        for dest in dest_rack_2:
            distribute_custom(pip = p300,
                            reagent = carrier_ez1_reagent,
                            tube_type = redcap_tube,
                            volume = 60,
    ...
    def step3():
        ...
        dest = dest_rack_3.wells()[:4]

        # transfer buffer to tubes
        for dest in dest_rack_3:
            distribute_custom(pip = p300,
                            reagent = carrier_ez1_reagent,
                            tube_type = redcap_tube,
                            volume = 60,
    ...
    STEPS = {
        ...
        2:{'Execute': False,  'Function': step1, 'Description': 'Transfer Primers 20 first wells/tubes'},
        3:{'Execute': False,  'Function': step1, 'Description': 'Transfer Primers 20 first wells/tubes'}
    }
