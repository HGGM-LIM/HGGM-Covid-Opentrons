...
# #####################################################
metadata = {
	'protocolName': 'Resistencias_1-Primers_SQ',
...
def run(ctx: protocol_api.ProtocolContext):
	...
	primers_plate = robot.load_labware('opentrons_24_tuberack_nest_2ml_screwcap', '7')
	...
	def step1():
		...
		for i, source in enumerate(primers_plate.wells()[0:NUM_SAMPLES]):
	...
	# -----------------------------------------------------
	STEPS = {
		1:{'Execute': True,  'Function': step1, 'Description': 'Transfer primers'},
	}
