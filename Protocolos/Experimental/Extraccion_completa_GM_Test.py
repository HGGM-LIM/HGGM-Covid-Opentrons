...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # -----------------------------------------------------
    STEPS = {
         1:{'Execute': False, 'Function': beads,      'Description': 'Transferir 40 µL de beads'},
         2:{'Execute': False, 'Function': isoprop,    'Description': 'Transferir 250 µL de isopropanol'},
