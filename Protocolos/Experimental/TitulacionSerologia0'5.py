...
def run(ctx: protocol_api.ProtocolContext):
    ...
    sample_rack = robot.load_labware('titulacin_96_wellplate_200ul', '11', 
        'titulacin_96_wellplate_200ul')
    
    titulacion_rack = robot.load_labware('titulacin_96_wellplate_200ul', '8', 
        'titulacin_96_wellplate_200ul')  

    diluyente_ori_rack = robot.load_labware('nest_12_reservoir_15ml', '5',
