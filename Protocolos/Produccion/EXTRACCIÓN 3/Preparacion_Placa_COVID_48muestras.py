...
# #####################################################
metadata = {
    'protocolName': 'Preparación Placa COVID 48 muestras',
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    def step1():
        ...
        list_dest=list(divide_destinations(dest_wells,48)) 
    ...
    # -----------------------------------------------------
    STEPS = {
        1:{'Execute': True,  'Function': step1, 'Description': 'Transfer Lisis'},
    }
