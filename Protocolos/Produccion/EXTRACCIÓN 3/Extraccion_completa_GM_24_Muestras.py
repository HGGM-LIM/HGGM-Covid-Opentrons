...
def run(ctx: protocol_api.ProtocolContext):
	...
	#isop_src = reagents_rack.columns()[5:7] #48 muestras
	...
	STEPS = {
		 ...
		 6:{'Execute': True, 'Function': d_600,      'Description': 'Desechar 600 µL de sobrenadante'},
		 7:{'Execute': True, 'Function': ethanol,    'Description': 'Transferir 600 µL de ethanol'},         
