...
__authors__ = ["Luis Torrico", "Aitor Gastaminza", "Alex Gasulla", "Sara Monzon" , "Miguel Julian", "Eva González" , "José Luis Villanueva", "Angel Menendez Vazquez", "Nick"]
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    Args:
        ctx (protocol_api.ProtocolContext): Description
    """
    global robot
    global tip_log
    ...
    #     2: {'Execute': True, 
    #         'description': 'Add internal control ('+str(volume_control)+'ul)'}
    # }
    ...
    # load labware
    buffer_rack = robot.load_labware('opentrons_6_tuberack_falcon_50ml_conical', '8',
        '6_tuberack_falcon source rack')

    dest_racks1 = [
        ctx.load_labware(
            'gmalum_24_aluminumblock_4000ul', slot,
            'source tuberack ' + str(i+1))
        for i, slot in enumerate(['11', '7', '4', '5'])
    ]


    # Set Reagens
    avl_reagent = Reagent(name = 'KPCR',
    ...
    # Set Tubes
    avl_tube1 = Tube(name = 'Falcon 50mL Conical Centrifuge Tubes',
                max_volume = 50000,
                actual_volume = 50000,
